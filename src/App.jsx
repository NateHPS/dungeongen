...
const ROOM_DATA = [
  ...
  "A discarded, single-gloved hand, seemingly severed, grasping a rusted key.",
  "A mural depicting figures with reversed heads, staring over their shoulders.",
  "The distant, rhythmic clang of metal on stone, echoing endlessly.",
  ...
  "A pool of shimmering, viscous liquid that seems to defy gravity, clinging to the edges.",
  ...
  "A tapestry depicting a landscape where all the trees are growing upside down.",
  ...
  "A small, closed wooden box emitting a faint, rhythmic scratching sound from within.",
  "A discarded, half-eaten piece of crystalline fruit that gives off a faint hum.",
  ...
  "A single, unlit candle on a tall, elegant silver candlestick, still smelling of beeswax.",
  ...
  "The floor is sticky with something that looks like dried honey.",
  ...
  "A circle of scorched earth, with nothing growing within it.",
  "A single, heavy iron door, covered in a thick layer of dust, with no visible handle or hinge.",
  ...
  "A small, ornate, brass key, glowing with a faint, internal light.",
  "The floor is covered in a uniform layer of fine, red sand, imported from elsewhere.",
  ...
  "The air is dry and tastes faintly of mineral dust.",
  ...
  "A single, large, crystalline spider, perfectly still, mounted on the wall.",
  ...
  "A pool of dark, swirling liquid that occasionally produces flashes of light.",
  "A pile of discarded, empty, glass jars, some with unidentifiable residue.",
  ...
  "The floor is covered in a thin, dry layer of what appears to be petrified dust.",
  ...
  "The sound of something skittering rapidly across the ceiling.",
  "A single, large, dead plant with glowing, crystalline leaves.",
  ...
  "A pervasive scent of petrichor, as if rain just fell, but everything remains mysteriously dry.",
  ...
  "Sporadic, distant chimes, like glass breaking, but without any visible source or resulting debris.",
  ...
  "A subtle, sweet aroma, like decaying fruit, hangs heavy, occasionally accompanied by a faint buzzing.",
  ...
  "Faint, rhythmic dripping sounds, but no visible source of water, suggesting a hidden, internal mechanism.",
  ...
  "Vibrant blue fungi that pulse with a soft bioluminescence, drawing unseen insects into their glowing caps.",
  "Thick, gnarled roots that seem to writhe and shift slightly when unobserved, like sleeping serpents.",
  ...
  "Trees with bark that resembles flaking human skin, weeping a clear, slightly viscous sap.",
  ...
  "Fungus that mimics the sound of distant voices, often repeating phrases heard hours before.",
  ...
  "Flowers that release a sleep-inducing pollen when agitated, causing a pleasant drowsiness.",
  "Root systems that have grown around and through ancient skeletons, incorporating them into the living plant structure.",
  ...
  "A large, circular stone table, its surface covered in strange, interlocking grooves that might hide a mechanism.",
  "A collection of chairs made from intricately carved, petrified wood, each one unique and unsettlingly lifelike.",
  ...
  "A throne made of interlocking gears and cogs, softly whirring and grinding even when no one is near.",
  ...
  "A set of crudely assembled stone benches arranged in a haphazard circle, as if for a forgotten ritual.",
  "A tall, narrow wardrobe filled with tattered, moth-eaten robes, each garment whispering faint, spectral words.",
  "A long, communal dining table made of rough-hewn timber, stained with ancient, dark spills that never fully dried.",
  ...
  "A strange, multi-tiered pedestal, each tier empty except for dust, but arranged as if for a specific, missing item.",
